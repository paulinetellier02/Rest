...
public class ConnectionRestNote extends AsyncTask<String, Void, String> {
    private final static String URL = "https://api.munier.me/jwt/";
    private JSONObject jsonObj = null;
    private String action = "notes";
    ...
    public String get(String methode) throws IOException, JSONException {
        ...
        InputStream is = null;
        String parameters = "";
        if(!methode.equals("POST")&&(jsonObj!=null)&&!methode.equals("CREATE_NOTES")){
        ...
        if (methode.equals("CREATE_NOTES")) {
            methode = "POST";
    ...
    public ArrayList<FctNote> parse(final String json) {
        try {
            final ArrayList<FctNote> list_note = new ArrayList<>();
