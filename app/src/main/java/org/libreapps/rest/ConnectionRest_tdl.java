...
import java.util.ArrayList;
/*
public class ConnectionRest_tdl extends AsyncTask<String, Void, String> {
    private final static String URL = "https://api.munier.me/jwt/";
    private JSONObject jsonObj = null;
    private String action = "tdl";
    ...
    public String get(String methode) throws IOException, JSONException {
        ...
        InputStream is = null;
        String parameters = "";
        if(!methode.equals("POST")&&(jsonObj!=null)&&!methode.equals("CREATE_TDL")){
    ...
    public ArrayList<Tdl> parse(final String json) {
        try {
            final ArrayList<Tdl> list_tdl = new ArrayList<>();
            final JSONArray jProductArray = new JSONArray(json);
            for (int i = 0; i < jProductArray.length(); i++) {
                list_tdl.add(new Tdl(jProductArray.optJSONObject(i)));
            }
            return list_tdl;
        } catch (JSONException e) {
